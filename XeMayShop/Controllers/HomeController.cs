...
namespace XeMayShop.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<Xe> xes1 = data.sp_8SanPhamBanChayTrongMotThang_HamGoi().ToList();
            ViewBag.SanPhamBanChayNhat = xes1;


            // lấy danh sách xe tay côn

            ViewBag.xetaycon = data.sp_Lay4XeTayCon().ToList();
            ViewBag.xetayga = data.sp_Lay4XeTayGa().ToList();
            ViewBag.xeso = data.sp_Lay4XeSo().ToList();
